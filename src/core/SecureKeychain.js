...
const defaultOptions = {
  ...
  authenticationPrompt: {
    title: 'Please authenticate in order to use MetaMask',
  },
  authenticationPromptDesc: 'Please authenticate in order to use MetaMask',
...
export default {
  ...
  async setGenericPassword(password, type) {
    ...
    const result = await Keychain.setGenericPassword('wiseapp-user', password, {
      ...defaultOptions,
      ...authOptions,
    });
