...
export async function getIdentityOwnerAddressNode(
  ...
  const publicKeyHex = Buffer.from(
    identityPrivateKeychain.publicKey.toString('hex'),
  );
...
export async function getBlockchainIdentities(
  ...
  const firstBitcoinAddress = getAddress(
    getBitcoinAddressNode(bitcoinPublicKeychainNode),
  );
...
export const ecPairToHexString = (secretKey: any) => {
